            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <p>Use search to find employee. You can search by: name, address, phone. Or use the advanced
                            search.</p>

                        <form class="form-horizontal" action="{{url('admin/employee/search')}}">
                        ...
                        <div class="panel {{$user->active==1?'panel-success':'panel-danger'}}">
                            <div class="panel-body profile">
                                ...
                                <div class="profile-controls">
                                    ...
                                    <a href="{{url('admin/employee/delete/'.$user->id)}}" class="profile-control-right"><span
